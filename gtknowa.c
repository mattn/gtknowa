...
#define APP_TITLE                  "GtkNowa"
#define APP_NAME                   "gtknowa"
#define APP_VERSION                "0.0.1"
#define APP_URL                    "http://mattn.kaoriya.net/gtknowa.xml"
#define SERVICE_NAME               "nowa"
#define SERVICE_UPDATE_URL         "http://api.nowa.jp/status_message/update.xml"
#define SERVICE_SELF_STATUS_URL    "http://api.nowa.jp/status_message/friends_timeline.xml"
#define SERVICE_FRIENDS_STATUS_URL "http://api.nowa.jp/status_message/friends_timeline/%s.xml"
#define SERVICE_THREAD_STATUS_URL  "http://api.nowa.jp/status_message/thread_timeline/%s.xml"
...
static gpointer update_friends_statuses_thread(gpointer data) {
	...
	if (status == 304)
		goto leave;
	if (response_mime && strcmp(response_mime, "text/xml")) {
